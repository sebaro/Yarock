...
if(TAGLIBCONFIG_EXECUTABLE)
  ...
  execute_process(COMMAND ${TAGLIBCONFIG_EXECUTABLE} --version RESULTS_VARIABLE _return_VALUE OUTPUT_VARIABLE TAGLIB_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
  ...
  if("${TAGLIB_MIN_VERSION}" VERSION_GREATER TAGLIB_VERSION)
     ...
     execute_process(COMMAND ${TAGLIBCONFIG_EXECUTABLE} --libs RESULTS_VARIABLE _return_VALUE OUTPUT_VARIABLE TAGLIB_LIBRARIES OUTPUT_STRIP_TRAILING_WHITESPACE)

     execute_process(COMMAND ${TAGLIBCONFIG_EXECUTABLE} --cflags RESULTS_VARIABLE _return_VALUE OUTPUT_VARIABLE TAGLIB_CFLAGS OUTPUT_STRIP_TRAILING_WHITESPACE)
