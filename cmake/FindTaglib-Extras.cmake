...
if(TAGLIB-EXTRASCONFIG_EXECUTABLE)
  ...
  exec_program(COMMAND ${TAGLIB-EXTRASCONFIG_EXECUTABLE} --version RESULTS_VARIABLE _return_VALUE OUTPUT_VARIABLE TAGLIB-EXTRAS_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
  ...
  if(TAGLIB-EXTRAS_VERSION STRLESS "${TAGLIB-EXTRAS_MIN_VERSION}")
     ...
     exec_program(COMMAND ${TAGLIB-EXTRASCONFIG_EXECUTABLE} --libs RESULTS_VARIABLE _return_VALUE OUTPUT_VARIABLE TAGLIB-EXTRAS_LIBRARIES OUTPUT_STRIP_TRAILING_WHITESPACE)

     exec_program(COMMAND ${TAGLIB-EXTRASCONFIG_EXECUTABLE} --cflags RESULTS_VARIABLE _return_VALUE OUTPUT_VARIABLE TAGLIB-EXTRAS_CFLAGS OUTPUT_STRIP_TRAILING_WHITESPACE)
