...
const QString S_GIT       = "<a href=\"https://gitlab.com/sebaro/Yarock\">Gitlab</a> or <a href=\"https://github.com/sebaro/Yarock\">Github</a>";
const QString S_TRANSLATE = "<a href=\"https://explore.transifex.com/sebastien/yarock-translation/\">transifex</a>";
...
const QString S_WEBSITE   = "<a href=\"https://bugs.launchpad.net/yarock\">website</a>";
...
void AboutScene::populateScene()
{
    ...
    /* proxy widget content */
      ...
      widget1->setAttribute(Qt::WA_OpaquePaintEvent, true);
      ...
      copyright->setText("(c) 2010-2019 Sebastien Amardeilh");
    ...
    text0->setHtml( QString(tr(
                "Yarock is a Qt modern music player designed to provide an easy and pretty music collection browser based on cover art.<br>"
    ...
    text3->setHtml(QString(tr("Please use %1 to report bugs.")).arg(S_LAUNCHPAD) + QString(tr("<br><br>For Qt6 version use %1 to report bugs.")).arg(S_GIT));
